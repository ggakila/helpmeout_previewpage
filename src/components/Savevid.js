...
export default function Savevid() {
  return (
		<div className='save-videoz flex flex-col items-center w-screen py-[48px] gap-y-[40px]'>
			<h1 className='text-[24px] w-1/2 text-center font-semibold text-gray-800'>
				To ensure the availability and privacy of your video, we recommend
				saving it to your account.
			</h1>
			<div className='bg-blue-900 px-[32px] py-[10px] border rounded-xl text-white text-[16px] font-medium save-vida'>save video</div>
